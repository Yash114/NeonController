...
Java_com_gingertech_starbeam_limelight_nvstream_jni_MoonBridge_init(JNIEnv *env, jclass clazz) {
    (*env)->GetJavaVM(env, &JVM);
    GlobalBridgeClass = (*env)->NewGlobalRef(env, (*env)->FindClass(env, "com/gingertech/starbeam/limelight/nvstream/jni/MoonBridge"));
...
Java_com_gingertech_starbeam_limelight_nvstream_jni_MoonBridge_startConnection(JNIEnv *env, jclass clazz,
