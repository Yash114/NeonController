package com.gingertech.starbeam.limelight.binding.input.driver;
...
public class UsbDriverService extends Service implements UsbDriverListener {
    ...
    public static boolean kernelSupportsXboxOne() {
        ...
        else // These aren't guaranteed to have backported kernel patches for proper Xbox One
        ...
        else return !kernelVersion.startsWith("4.4.") && !kernelVersion.startsWith("4.9.");
    }
    ...
    public static boolean kernelSupportsXbox360W() {
        ...
        if (kernelVersion != null) {
            ...
            return !kernelVersion.startsWith("2.") && !kernelVersion.startsWith("3.") &&
