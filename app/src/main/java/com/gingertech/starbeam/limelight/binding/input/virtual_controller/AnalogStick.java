...
package com.gingertech.starbeam.limelight.binding.input.virtual_controller;
...
public class AnalogStick extends VirtualControllerElement {
     ...
     */
    private final boolean circle_stick = true; // TODO: implement square sick for simulations
    ...
    private final List<AnalogStickListener> listeners = new ArrayList<>();
