...
public class PreferenceConfiguration {
    ...
    private static final String FILL_PREF_STRING = "checkbox_fill_video";
    ...
    public static PreferenceConfiguration readPreferences(Context context) {
        ...
        config.fillVideo = prefs.getBoolean(FILL_PREF_STRING, DEFAULT_STRETCH);
