...
import static com.gingertech.starbeam.limelight.preferences.StreamSettings.displayCutoutP;
...
public class SettingsController extends PreferenceFragmentCompat {
...
//                        (PreferenceCategory) findPreference("category_input_settings");
//
//                if(findPreference("checkbox_vibrate_fallback") != null) {
...
//                if (category != null) {
//                    if(findPreference("checkbox_vibrate_osc") != null) {
                ...
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    ...
                    h.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            MainActivity settingsActivity = (MainActivity) SettingsController.this.getActivity();
